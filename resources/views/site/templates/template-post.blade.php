...
<html>
    <head>
        ...
        <meta property="og:url"           content="{{url("/tutorial/{$postContadorCodigo2->url}/$id")}}" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="{{$post->title}}" />
        <meta property="og:description"   content="{!! str_limit($post->description,200) !!}" />
        <meta property="og:image"         content="{{url("assets/uploads/posts/{$postContadorCodigo2->image}")}}"/>
