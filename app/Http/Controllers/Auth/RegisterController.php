...
class RegisterController extends Controller
{
    ...
    */
    ...
    { 
           ...
           //Aqui estamos realizando a contagem dos cadastros realizados pelo código passado.
                   
          $dados = $this->contador->find($data['codigo']);
          
        $dados1 = $this->contador->find($data['codigo']);
          ...
          $update=$dados1->update(['contador'=>$dados['contador']]);
